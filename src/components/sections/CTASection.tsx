  ...
  return (
    <section id="cta" className="paper-noise section-padding border-b-2 border-foreground">
      <div className="container-custom">
        ...
        <div className="mt-9 grid border-2 border-foreground sm:mt-12 lg:grid-cols-2">
          <article className="bg-primary p-6 text-primary-foreground sm:p-10 lg:p-12">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-accent">I&apos;m a brand</p>
            <h3 className="mt-6 font-display text-4xl uppercase leading-[0.95] sm:mt-8 sm:text-6xl sm:leading-[0.9]">Put your campaign in hand.</h3>
          ...
          <article className="border-t-2 border-foreground bg-accent p-6 text-accent-foreground sm:p-10 lg:border-l-2 lg:border-t-0 lg:p-12">
            <p className="text-xs font-bold uppercase tracking-[0.2em]">I run a café</p>
            <h3 className="mt-6 font-display text-4xl uppercase leading-[0.95] sm:mt-8 sm:text-6xl sm:leading-[0.9]">Get your cup costs covered.</h3>
        ...
        <div className="mt-12 grid gap-8 border-t-2 border-foreground pt-10 sm:mt-16 sm:gap-10 sm:pt-12 lg:grid-cols-[0.75fr_1.25fr]">
          <div>
          ...
          <div className="poster-panel p-4 sm:p-8">
